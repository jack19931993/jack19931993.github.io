...
var e=null,t=null,n=null,a=function(){s(void 0,void 0),i.default.postMessage({action:"track_activity",payload:{seen:t}})}.bind(void 0),r=function(){s(void 0,void 0),t=(new Date).getTime()}.bind(void 0),d=function(e){s(void 0,void 0),o.default.unbindEvent("keypress",r),o.default.unbindEvent("mousemove",r),o.default.unbindEvent("click",r),e&&(o.default.bindEvent("keypress",r),o.default.bindEvent("mousemove",r),o.default.bindEvent("click",r))}.bind(void 0),u=function(){s(void 0,void 0)
var i=(new Date).getTime()
null===n||null===t||e&&(i<e||t<e||i-e<59e3||t>e&&t<i&&a()),e=i}.bind(void 0),l=function(){s(void 0,void 0),n&&clearInterval(n),n=null,t=null,e=null}.bind(void 0),f=function(){s(void 0,void 0),l(),d(!0),e=(new Date).getTime(),n=setInterval(u,6e4)}.bind(void 0),c=function(){s(void 0,void 0),t=(new Date).getTime(),a(),l(),d(!1)}.bind(void 0),g=function(){s(void 0,void 0),"hidden"===document.visibilityState&&c()}.bind(void 0)
return{start:function(){f(),o.default.bindEvent("focus",f),o.default.bindEvent("blur",c),o.default.bindEvent("beforeunload",c),o.default.bindEvent("visibilitychange",g)},stop:function(){c(),o.default.unbindEvent("focus",f),o.default.unbindEvent("blur",c),o.default.unbindEvent("beforeunload",c),o.default.unbindEvent("visibilitychange",g)}}}.bind(void 0)()},{"./../../utils/common/dom":11,"./../../utils/frame":15}],4:[function(e,t,n){"use strict"
Object.defineProperty(n,"__esModule",{value:!0})
...
Object.defineProperty(n,"__esModule",{value:!0}),n.default={SAMPLE_TOKEN:"WEB_CHAT_TOKEN",frameDivId:"fc_frame",frameId:"fc_widget",pushFrameDivId:"fc_push_frame",pushFrameId:"fc_push",modalDivId:"fc_web_modal",classes:{fullscreenClass:"fc-widget-fullscreen"}}},{}],8:[function(e,t,n){"use strict"
...
t.type="text/javascript",t.src=n+"/js/cb.js",(document.body?document.body:document.getElementsByTagName("head")[0]).appendChild(t),window.fc_cobrowse={host:e.host,locale:e.locale}}}}.bind(void 0)()},{"./common/dom":11}],11:[function(e,t,n){"use strict"
Object.defineProperty(n,"__esModule",{value:!0})
var i,o,a,s,r,d,u,l,f,c,g=e("../../../config/cb_environment"),m=(i=g)&&i.__esModule?i:{default:i}
...
if(o=e.childNodes)for(n=o.length,t=0;t<n;t+=1)this.purge(e.childNodes[t])},cdn_url:function(){if(m.default&&m.default.config){var e=m.default.config.type,t=m.default.config.cdn
...
break}}},publish:function(t,n,i){if(this.valid(t)){var o=e&&e[t]
if(o)for(var a=function(e){return function(){n?e(n):e()}},s=0,r=o.length;s<r;s++){var d=a(o[s])
...
Object.defineProperty(n,"__esModule",{value:!0})
var i,o=h(e("./common/dom")),a=h(e("./frame")),s=h(e("./events")),r=h(e("../obj/constants")),d=h(e("../obj/state")),u=h(e("../obj/user")),l=h(e("./msg_handler")),f=h(e("./push_frame")),c=h(e("../helpers/modal")),g=h(e("../helpers/omni")),m=h(e("./msg_processor")),p=h(e("./cb"))
...
if(this.updateFrameSettings(h.settingsPayload),v){var b=document.getElementById(r.default.frameDivId),w=i&&i.expanded||"expanded"
...
break
case"notify_frame":var _=h.data,y=document.getElementById(r.default.frameDivId),E=i&&i.open||"fc-open"
...
break
case"resize_frame":var I=document.getElementsByTagName("BODY")[0],C=i&&i.open||"fc-open"
d.default.opened(h.isOpen),d.default.isOpened()?(this.removeScrollEventAndStyleFromWidget(),b.classList.add("h-open-container"),b.classList.add(C),s.default.publish("widget:opened"),I&&I.classList.add("fc-widget-open")):(b.removeAttribute("style"),b.classList.remove("h-open-container"),b.classList.remove(C),s.default.publish("widget:closed"),I&&I.classList.remove("fc-widget-open"))
break
case"toggle_frame":h.show?b.classList.remove("hide"):-1===b.className.trim().indexOf("hide")&&b.classList.add("hide")
break
...
break
case"frame_state_change":var L=document.getElementById(r.default.frameDivId),k=h&&h.data,O=k&&k.frameState,M=a.default.getSettings()&&a.default.getSettings().enabledFeatures
s.default.publish("frame:statechange",h),"initialized"===O&&(a.default.isJWTEnabled()&&a.default.isJWTStrictMode()&&L.classList.add("fc_dn"),this.loadWidget(),M&&-1!==M.indexOf("COBROWSING")&&p.default.init({host:a.default.getHost(),locale:u.default.getProperties().locale})),"loaded"===O&&a.default.loaded(!0),"authenticated"!==O&&"not_authenticated"!==O||a.default.isJWTEnabled()&&a.default.isJWTStrictMode()&&(h.success?L.classList.remove("fc_dn"):304!==h.status&&this.unloadWidget())
break
...
break
case"rules_loaded":g.default.init(),m.default.start()
break
case"enlarge_image":c.default.create(h.picUrl)
break
case"expand_all":document.getElementById(r.default.frameDivId).classList.add("expanded-modal"),document.getElementById(r.default.frameDivId).classList.add(w)
break
case"collapse_all":document.getElementById(r.default.frameDivId).classList.remove("expanded-modal"),document.getElementById(r.default.frameDivId).classList.remove(w)
break
...
break
case"user_created":var P=h.data
if(d.default.isLoaded())P&&u.default.setRestoreId(P.restoreId),this.onUserCreate(h)
else if(h.success){var T=P&&P.externalId,S=P&&P.restoreId,x=u.default.getExternalId()
x?x===T&&(u.default.setRestoreId(S),this.onUserCreate(h)):this.onUserCreate(h)}else this.onUserCreate(h)
break
...
break
case"set_storage_item":if(o.default.storageAvailable){var A=h.data
A&&A.key&&A.value&&localStorage.setItem(A.key,JSON.stringify(A.value))}break
case"remove_storage_item":if(o.default.storageAvailable){var N=h.data
...
n?a.default.dispatch(t,{success:200===n,status:n}):a.default.dispatch(t,{success:!1,status:400})}}},{"../helpers/modal":1,"../helpers/omni":2,"../obj/constants":7,"../obj/state":8,"../obj/user":9,"./cb":10,"./common/dom":11,"./events":14,"./frame":15,"./msg_handler":18,"./msg_processor":19,"./push_frame":21}],17:[function(e,t,n){"use strict"
Object.defineProperty(n,"__esModule",{value:!0})
...
Object.defineProperty(n,"__esModule",{value:!0}),n.default=function(){(function(e,t){if(e!==t)throw new TypeError("Cannot instantiate an arrow function")})(void 0,void 0)
var e=[],t=!1
return{enque:function(n){t||(void 0===e&&(e=[]),e.push(n))},deque:function(){if(e&&e.length)return e.shift()},toggleLock:function(e){t=e},isLocked:function(){return t},isEmpty:function(){return!e||!e.length}}}.bind(void 0)()},{}],23:[function(e,t,n){"use strict"
Object.defineProperty(n,"__esModule",{value:!0})
var i=v(e("./obj/constants")),o=v(e("./obj/state")),a=v(e("./obj/user")),s=v(e("./utils/msg_promise")),r=v(e("./utils/msg_callback")),d=v(e("./utils/msg_handler")),u=v(e("./utils/common/dom")),l=v(e("./utils/frame")),f=v(e("./utils/message")),c=v(e("./utils/events")),g=v(e("./utils/push_frame")),m=v(e("./helpers/omni/analytics")),p=v(e("./helpers/omni/transition")),h=v(e("./helpers/omni"))
...
return{init:function(e){var t,n,s,r,d=-1!==["Chrome","Firefox","Safari","Edge","Trident","WebView"].indexOf(u.default.getAgent.name),g=-1!==["Station"].indexOf(u.default.getAgent.appName)
if(d&&!g&&!this.isInitialized()){var m=e&&e.token
m&&m.toUpperCase()!==i.default.SAMPLE_TOKEN&&(window.location.origin||(window.location.origin=window.location.protocol+"//"+window.location.hostname+(window.location.port?":"+window.location.port:"")),e.referrer=btoa(window.location.origin),void 0===e.open&&(e.open=!1),r=e,o.default.reset(),a.default.reset(),h.default.destroy(),f.default.unsubscribe(),l.default.init({host:r.host.trim(),token:r.token.trim(),referrer:r.referrer,siteId:r.siteId,jwtAuthToken:r.jwtAuthToken}),o.default.openOnLoad(r.open),r.identifyByReferenceId&&a.default.setIdentifyByReferenceId(!0),r.externalId&&(a.default.setExternalId(r.externalId),a.default.setRestoreId(r.restoreId)),r.tags&&r.tags.length&&o.default.setTags(r.tags),r.faqTags&&o.default.setFaqTags(r.faqTags),a.default.setProperties({firstName:r.firstName,lastName:r.lastName,email:r.email,phone:r.phone,phoneCountry:r.phoneCountryCode,locale:r.locale,meta:r.meta}),a.default.setConfig(r.config),r.onLoad&&c.default.subscribe("widget:loaded",r.onLoad),l.default.add(),f.default.subscribe(),t=document,n=t.createElement("link"),s=u.default.cdn_url()?u.default.cdn_url():l.default.getHost(),n.href=s+"/css/widget.css?t="+(new Date).getTime(),n.rel="stylesheet",t.getElementsByTagName("head")[0].appendChild(n))}},destroy:function(){g.default.unload(),l.default.unload()},isOpen:function(){return o.default.isOpened()},isInitialized:function(){return!!l.default.getToken()},isLoaded:function(){return o.default.isLoaded()},on:function(e,t){c.default.subscribe(e,t)},off:function(e,t){c.default.unsubscribe(e,t)},open:function(e){e?d.default.subscribe("open_channel",e):d.default.subscribe("open_chat")},close:function(){d.default.subscribe("close_chat")},show:function(){d.default.subscribe("show_chat")},hide:function(){d.default.subscribe("hide_chat")},setTags:function(e){o.default.isLoaded()&&(e&&e.length?o.default.setTags(e):o.default.setTags([]),d.default.subscribe("set_tags",{tags:o.default.getTags(),force:!0}))},setFaqTags:function(e){o.default.isLoaded()&&(e?o.default.setFaqTags(e):o.default.setFaqTags({}),d.default.subscribe("set_faq_tags",{faqTags:o.default.getFaqTags(),force:!0}))},setExternalId:function(e,t){var n={}
...
r.default.send("generate_user_uuid",e)}},track:m.default.track,trackPage:function(e,t){p.default.track({newValue:e,title:t,force:!0})},authenticate:function(e){var t=this
